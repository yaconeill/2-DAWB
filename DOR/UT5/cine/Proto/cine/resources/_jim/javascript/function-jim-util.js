...
//                var cellPaddingBottomWidth = isNaN(jimEvent.fn.getCurrentStyle('padding-bottom',$currentCell)) ? 0 : jimEvent.fn.getCurrentStyle('padding-bottom',$currentCell);
               ...
               cellWidth = Math.max(parseInt(($currentCell.data("originalWidth")*newTableWidth)/$table.data("originalWidth"))-cellBorderLeftWidth- cellBorderRightWidth/* - cellPaddingLeftWidth - cellPaddingRightWidth*/,1);
               cellHeight = Math.max(parseInt(($currentCell.data("originalHeight")*newTableHeight)/$table.data("originalHeight"))-cellBorderTopWidth - cellBorderBottomWidth/* - cellPaddingTopWidth - cellPaddingBottomWidth*/,1);
