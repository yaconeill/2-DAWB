...
function basicInputs() {
    ...
    createElement('input', divInputs, null, 'type', 'color', 'id', 'SecondaryColor', 'value', colorDefault);
    createElement('br', divInputs);
    ...
    createElement('p', divInputs, 'Clica en las celdas y descubre lo que hay debajo');
}
